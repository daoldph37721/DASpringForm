    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${page}" var="category">
            <tr>
                ...
                <td>${category.name}</td>
                <td>
                    <a href="admin/category/update/${category.id}" class="btn btn-outline-warning">Sửa</a>
                    <a href="admin/category/delete/${category.id}" onclick="return confirm('Bạn có chắc xóa không?')" class="btn btn-outline-danger">Xóa</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
