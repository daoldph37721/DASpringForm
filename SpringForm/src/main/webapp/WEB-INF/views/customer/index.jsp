            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link"
                                             href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=0">&laquo;</a></li>
                    <li class="page-item"><a class="page-link"
                                             href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.number-1}"
                                             onclick="if (${page.number==0}){
                                                     return false;
                                                     }">&lsaquo;</a></li>
                    <li class="page-item"><a class="page-link"
                                             href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.number+1}"
                                             onclick="if (${page.number}==${page.totalPages-1}){
                                                     return false;
                                                     }">&rsaquo;</a></li>
                    <li class="page-item"><a class="page-link"
                                             href="?keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}&p=${page.totalPages-1}">&raquo;</a>
                    </li>
                </ul>
